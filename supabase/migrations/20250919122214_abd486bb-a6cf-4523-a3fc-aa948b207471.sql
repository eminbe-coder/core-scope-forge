-- Create triggers to automatically award points for user actions

-- Trigger for completing todos
CREATE OR REPLACE FUNCTION public.trigger_award_points_todo_completion()
RETURNS TRIGGER
LANGUAGE plpgsql
SECURITY DEFINER
...
CREATE OR REPLACE FUNCTION public.trigger_award_points_deal_creation()
RETURNS TRIGGER
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
...
CREATE OR REPLACE FUNCTION public.trigger_award_points_contact_creation()
RETURNS TRIGGER
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
...
CREATE OR REPLACE FUNCTION public.trigger_award_points_company_creation()
RETURNS TRIGGER
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
...
CREATE OR REPLACE FUNCTION public.trigger_award_points_deal_stage_move()
RETURNS TRIGGER
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
...
-- Create trigger for deal stage moves
...
CREATE OR REPLACE FUNCTION public.trigger_award_points_contract_conversion()
RETURNS TRIGGER
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
...
-- Trigger for adding site relations (company_sites and contact_sites)
CREATE OR REPLACE FUNCTION public.trigger_award_points_site_relation()
RETURNS TRIGGER
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
...
-- Create triggers for site relations
